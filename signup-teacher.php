...
if (isset($_POST['submit'])) {
  $check_phone = mysqli_query($con, "SELECT phone FROM teachers WHERE phone = '".$_POST['phone']."'");
  $check_email = mysqli_query($con, "SELECT email FROM teachers WHERE email = '".$_POST['email']."'");
  if ($_POST['password'] != $_POST['repeat']) {
    ...
    $sql = "INSERT INTO teachers(name, surname, patronymic, email, phone, region, password) VALUES ('".$_POST['name']."','".$_POST['surname']."','".$_POST['patronymic']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['region']."','".$_POST['password']."')";
