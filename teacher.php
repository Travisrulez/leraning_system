        ...
        <form action="" method="post" class="profile__form">
          ...
          <div class="profile__form-group form-group">
            ...
            <div class="form-group__item">
              ...
              <input name="position" id="position" type="text" class="input" value="Преподаватель" disabled>
            </div>
          </div>
    ...
    <div class="workspace__container _container">
      ...
      <div class="cards">
        <div class="cards__title">
          <h2>Карточки преподавателя</h2>
          <a href="add-card.php" class="cards__new-card">Добавить карточку</a>
        </div>
        <?php 
        ...
        <div class="cards__content">
          <div class="cards__item card">
            ...
            <a class="btn-edit" href="edit-card.php?edit_card=<?=$cards['id']?>" title="Редактировать"><i class="fa fa-pencil" aria-hidden="true"></i></a>
              <a class="btn-delete" href="del-card.php?del_card=<?=$cards['id']?>" title="Удалить"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
            </div>
          </div>
        </div>
        <?php endforeach; ?>
        ...
        <div class="students__title">
          ...
          ?>
            <div class="students__item card">
              ...
              <a class="btn" href="tel:<?=$students['phone']?>">Связаться</a>
              </div>
            </div>
            <?php endforeach; ?>
          </div>
